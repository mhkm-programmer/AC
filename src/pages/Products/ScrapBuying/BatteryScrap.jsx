...
const BatteryScrap = () => {
  return (
    <div className="font-sans text-gray-800">
      ...
      {/* SEO */}
      <PageTitle title="Battery Scrap Buying in Doha | Contact Trading Co." />
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 text-center">
        <h2 className="text-4xl md:text-5xl font-bold text-[#0A2540] mb-6">
          Sell Your Battery Scrap in Doha
        </h2>
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          Contact Trading Co. buys all types of battery scrap, including car batteries, inverter batteries, and industrial batteries.
          We provide fast inspection, fair pricing, and hassle-free pickup anywhere in Doha. Turn your old batteries into cash today!
        </p>
      </section>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10">
          ...
          <div className="space-y-5">
            <h3 className="text-2xl font-semibold text-[#0A2540]">
              Why Sell Battery Scrap to Us?
            </h3>

            <p className="flex items-start gap-3">
              <FaCheckCircle className="text-green-500 mt-1" />
              Competitive pricing for all battery types
            </p>
            ...
            <p className="flex items-start gap-3">
              <FaCheckCircle className="text-green-500 mt-1" />
              Accepts car, inverter, and industrial batteries
            </p>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <h3 className="text-2xl font-semibold text-center text-[#0A2540] mb-10">
          Collected Battery Scrap
        </h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {batteryGallery.map((src, index) => (
            <div
              key={index}
      ...
      <section className="py-20 bg-[#0A2540] text-white text-center px-6">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-4">
          <a
            href="https://wa.me/97450791874?text=I%20want%20to%20sell%20battery%20scrap"
